...
let cancDensidade = (area, populacao) => populacao / area
...
for(let i = 0; i < estadosNe.length; i++) {
    estadosNe[i]['densidade demográfica'] = cancDensidade(estadosNe[i].area, estadosNe[i].populacao)
...
let exibeObj = obj => {
    ...
    } //para exibir o valor da propriedade é necessario passar o objeto 
    // com a propriedade entre colchetes
}
